...
export const siteTitle = 'Short Fuse Shop';
...
export const Layout: React.FC<LayoutProps> = ({ pageTitle, children, navigation }) => {
    ...
    return (
        <MainStack>
            ...
            />
            <Navigation changeModal={changeModal} navigation={navigation} />
