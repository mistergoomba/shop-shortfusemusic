...
export const ProductPage: React.FC<InferGetStaticPropsType<typeof getStaticProps>> = props => {
    ...
    console.log(variant?.stockLevel);
                    ...
                    <Main gap="5rem">
                        ...
                        <StyledStack w100 column gap="2rem">
                            ...
                            <Stack w100 gap="1rem" column>
                                {variant && variant.stockLevel === 'LOW_STOCK' && (
                            ...
                            {!variant ? null : variant.stockLevel === 'OUT_OF_STOCK' ? (
                                <NotifyMeForm />
                            ) : (
                            ...
                            <ProductDescription
                                data={[
                                    {
                                        children: (
                                            <TP size="1.25rem" weight={400} style={{ whiteSpace: 'pre-wrap' }}>
